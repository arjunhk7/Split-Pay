  ...
  <input type="radio" name="split" value="se" id="se"  > Split Equally

  <input type="radio" name="split" value="su" id="su"> Split Unequally<br></br>
  <input type="radio" name="meth" value="mc" id="mc"> Multiple Contributors
  <input type="radio" name="meth" value="sc" id="sc"> Single Contributor<br></br>



   <input type="submit" name="add" ID="add" value="ADD BILL"/>
    </div>
      ...
      if(document.getElementById('se').checked) {
          ...
          if(document.getElementById('sc').checked) {
                  ...
                  var name = $('input#name').val();
                      ...
                      if($.trim(name) !='') {
                      $.post('sesc.php',{name:name},function(data){

                                                        location.href = 'semc.php';
    ...
    if(document.getElementById('su').checked) {
        ...
        if(document.getElementById('sc').checked) {
              ...
              var name = $('input#name').val();
                  ...
                  if($.trim(name) !='') {
                  $.post('susc.php',{name:name},function(data){

                            location.href = 'susc.php';
