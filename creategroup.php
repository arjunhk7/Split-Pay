...
<form name="add_name" method="POST"  id="add_name">
 ...
 <input type="text" name="grpnam" placeholder="GROUP NAME" id="grp">
 <br/><br/>


 <input type="email" name="adm" placeholder="ADMIN EMAIL ID" id="adm">
 <br/><br/>
 <input type="name" name="admn" placeholder="ADMIN NAME" id="admn">
 <br/><br/>
 ...
 <br/><br/>
   ...
   <div class='main'>
 <p>ADD MEMBERS</p><br/><br/>
 <input type="text" name="grpname" placeholder="GROUP NAME" id="grpn">
 <br/><br/>

 <input type="email" name="email1" placeholder="USER EMAIL ID" id="us">
<div id= "namid">
  <br/><br/>
<input type="text" name="usern" placeholder="USER NAME" id="un">
 <div id= "namid">
 </div>
  ...
  <br/>
  <input type="button" name="addbutton"  value="ADD USER" id="add"/>
